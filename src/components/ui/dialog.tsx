  ...
  'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full translate-x-[-50%] translate-y-[-50%] gap-4 p-6 shadow-lg duration-200',
  {
    variants: {
      variant: {
        ...
        appointment:
          'bg-background-tertiary border-none rounded-lg max-w-[calc(100%-2rem)] sm:max-w-119.25 max-h-[90vh] overflow-y-auto',
        large:
...
export {
  Dialog,
  DialogClose,
  DialogContent, dialogContentVariants, DialogDescription, dialogDescriptionVariants, DialogFooter,
  DialogHeader, dialogHeaderVariants, DialogOverlay, dialogOverlayVariants, DialogPortal,
  DialogTitle, dialogTitleVariants, DialogTrigger
};
